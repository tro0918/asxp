...
els.export.onclick=()=>{state.exported=true;els.packet.classList.add('exported');els.packetState.textContent='v1.0.0 · verified';els.import.disabled=false;els.inspect.disabled=false;stage(1);log('success','PACK','refund-policy@1.0.0 → .asxp artifact');log('','INTEGRITY','per-file SHA-256 · revision 7e91c4d8');toast('.asxp 패키지를 Export했습니다')};
